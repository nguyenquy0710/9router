...
export const MODEL_PRICING = {
  ...
  // === FPT Cloud ===
  // url: https://ai.fptcloud.com/Nguyen%20Quy%20Blog/pricing/maas
  "gpt-oss-20b": { input: 0.0495, output: 0.198, cached: 0, reasoning: 0, cache_creation: 0 },
  "gemma-3-27b-it": { input: 0.110, output: 0.165, cached: 0, reasoning: 0, cache_creation: 0 },
  "Qwen3-32B": { input: 0.165, output: 0.187, cached: 0, reasoning: 0, cache_creation: 0 },
  "SaoLa-Llama3.1-planner": { input: 0.055, output: 0.088, cached: 0, reasoning: 0, cache_creation: 0 },
